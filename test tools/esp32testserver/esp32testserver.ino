...
const char *ssid = "Gays wifi"; // don't steal my wifi password random github user. Also we did not name it as a joke. The sweet old lady in our house before us had the name Gay Love. Click the link if you dont believe me! https://www.legacy.com/us/obituaries/atlanta/name/gay-love-obituary?id=16562422
const char *password = "17711771";
